...
(= this-site*    "Arxiv News"
   site-url*     "http://www.arxiv-news.com/"
   parent-url*   "http://www.arxiv-news.com"
   favicon-url*  ""
   site-desc*    "News aggregator for arxiv.org"               ; for rss feed
   site-color*   (color 179 27 27)
...
.admin   { font-family:Verdana; font-size:8.5pt; color:#ffffff; }
...
.pagetop { font-family:Verdana; font-size: 10pt; color:#dddddd; }
